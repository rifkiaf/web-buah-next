        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-8 text-center">
          ...
          <div className="flex flex-col items-center">
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/" className="text-green-200 hover:text-white transition-colors flex items-center space-x-2 justify-center">
                  <span>→</span>
                  <span>Beranda</span>
                </Link>
              </li>
              <li>
                <Link href="/products" className="text-green-200 hover:text-white transition-colors flex items-center space-x-2 justify-center">
                  <span>→</span>
                  <span>Produk</span>
                </Link>
              </li>
              <li>
                <Link href="/login" className="text-green-200 hover:text-white transition-colors flex items-center space-x-2 justify-center">
                  <span>→</span>
                  <span>Masuk</span>
                </Link>
              </li>
